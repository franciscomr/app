        ...
        <table class="w-full bg-white dark:bg-neutral-800">
          <thead>
            <tr class="w-full h-12 ">
              ...
              <th v-for="relationship in relationships" class="px-1 border-b text-sm font-semibold border-neutral-100 dark:text-neutral-100  dark:border-neutral-700">
              {{ relationship.name }}
            </th>
            </tr>
          </thead>
...
export default {
  ...
  setup(props) {
    ...
    return {dataReceived,sortBy,sort, showFilterMenu, filters, rangeDateArray,changePageDisplayed, pagination}
  }
